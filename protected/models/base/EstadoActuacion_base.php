 ...
 */
class EstadoActuacion_base extends _BASEActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('estado_actuacion', 'length', 'max'=>250),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, id_empresa, estado_actuacion', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'actuacions' => array(self::HAS_MANY, 'Actuacion', 'id_estado_actuacion'),
	...
	public function attributeLabels()
	{
		return array(
			...
			'estado_actuacion' => 'Estado Actuacion',
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('estado_actuacion',$this->estado_actuacion,true);
